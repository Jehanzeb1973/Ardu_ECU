      ...
      .buttongreen {background-color: #4CAF50;} /* Green */
        ...
        <p>
           <a  href="/" class="button">Page1</a>
            ...
            <a  href="/page5" class="button buttongreen">Page5</a>
   ...
   <div class="content">
      <div class="card-grid">
        ...
        <div class="card">
         ...
         <div class="card">
          <p class="card-title">Thrust</p>
          <canvas id="gauge-thrust"></canvas>
        </div>
      </div>
    </div>
    <script>
...
var gaugepressure = new LinearGauge({
  ...
  // Create Thrust Gauge
var gaugethrust = new LinearGauge({
    ...
    console.log(myObj);
      ...
      document.getElementById("rpm").innerHTML = myObj.rpm;
       document.getElementById("thrust").innerHTML = myObj.loadcellvalue;
        document.getElementById("pressure").innerHTML = myObj.casepressure;
