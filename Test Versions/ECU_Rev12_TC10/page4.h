...
<body>
    <div class="container">
        ...
        <p>Arduino ECU Data Terminal</p>
           ...
           <a  href="/" class="button">Page1</a>
            ...
            <a href="/page4" class="button buttongreen">Page4</a>
   ...
   <div class="content">
            <div class="card" >
          <p class="card-title"  align="center" >Temperature-Pressure</p>
...
var gaugePress = new LinearGauge({
...
function getReadings(){
  ...
  xhr.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      var rpm = myObj.rpm;
      var pressure = myObj.caseressure;
      gaugeTemp.value = temp;
      gaugerpm.value = rpm;
      gaugePress.value=pressure;
    }
  }; 
...
if (!!window.EventSource) {
  ...
  source.addEventListener('new_readings', function(e) {
    ...
    gaugePress.value=myObj.casepressure;
  }, false);
}
  </script>
